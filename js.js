...
//   ??? в будущем раздеить функцию чтобы не переписывать каждый раз див
...
function chekOnWrongLetter(a){
	...
	var lastLet = (a.charAt(a.length-1));
	if(lastLet == "ъ" || lastLet == "ь" || lastLet == "ы" || lastLet == "й"){
		lastLet = (a.charAt(a.length-2));
	}
	return lastLet;
}
